...
Ce projet est une implémentation en Java de Enigma, une machine électromécanique portative servant au chiffrement et au déchiffrement de l'information. 
Elle a été principalement utilisée par l'Allemagne pendant la Seconde Guerre mondiale.
